  ...
  return (
    <>
              ...
              <div className="card has-background-grey-dark has-text-light">
                <div className="card-content">
                  ...
                  <h2 className="subtitle has-text-light">
                    ...
                    social distancing and quarantine. Lower amounts of patrons
                    and restaurants closing will be tough on everyone. Every
                    little bit helps.
                  </h2>
                  <p>
      ...
      <footer className="support-footer has-text-white">
        ...
        |{" "}
        <a href="mailto:" className="has-text-white">
